package com.example.androidgeographytests.Activities
...
import com.example.androidgeographytests.Fragments.DataToPassThrough
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (i in IntStream.range(1, 82))
            numbers.add(i - 1, DataToPassThrough(i))
        numbers.shuffle()
        ...
        val rpView = findViewById<RichPathView>(R.id.rpView)

        val textView = findViewById<TextView>(R.id.textView)

        textView.textView.text = "Найдите " + subjectsMap[number]
        ...
        if (savedInstanceState != null) {
            ...
            textView.text = "Найдите " + subjectsMap[number]
        }
        ...
        rpView.setOnPathClickListener{
            if (mistake_count >= 4)
                rpView.findRichPathByName(number.toString())?.fillColor = Color.BLUE
        ...
        rpView.setOnTouchListener(object : View.OnTouchListener {
